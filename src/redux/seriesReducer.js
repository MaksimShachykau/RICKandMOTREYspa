...
export const setDataInSeries = (data) => ({type: SET_DATA_IN_SERIES, data})
export const setDataSeries = (url, air_date, episode, id, name) => ({type: SET_DATA_SERIES, url, air_date, episode, id, name}) 